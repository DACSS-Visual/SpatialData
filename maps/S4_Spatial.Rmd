...
```
```{r}
zipMap$area_km2=drop_units(units::set_units(st_area(st_make_valid(zipMap)),'km2'))
...
library(sf)
wazipMap <- sf::read_sf("SAEP_ZIP_Code_Tabulation_Areas.shp") 
```
...
```{r}
wazipMap=wazipMap[,c(1,2,3,7,8,15,20,25,102)]
st_write(wazipMap, "wazipMap.gpkg", layer = "zips")
```
